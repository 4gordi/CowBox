...
const uint8_t bmp_logo_pgm[] PROGMEM = {
	
};
...
const char menu_options_text_pgm[]   PROGMEM = "Settings";
const char menu_contrast_text_pgm[]  PROGMEM = "Brightness";
const char menu_invert_text_pgm[]    PROGMEM = "Invert";
const char menu_flip_text_pgm[]      PROGMEM = "Rotate Screen";
const char menu_light_text_pgm[]     PROGMEM = "Time backlight";
const char menu_reset_text_pgm[]     PROGMEM = "Reboot";
const char menu_help_text_pgm[]      PROGMEM = "Info";
const char menu_about_text_pgm[]     PROGMEM = "About";

const char data_about_text_pgm[]     PROGMEM = "  by 4gordi";
const char data_help_text_pgm[]      PROGMEM = "Менеджер паролей — это зашифрованное аппаратное хранилище, в котором находится защищенная информация о входе в систему с паролем, которую вы используете для доступа к приложениям и учетным записям.";

const char data_space_text_pgm[]     PROGMEM = "                     ";
const char data_auth_text_pgm[]      PROGMEM = "Enter PIN";
const char data_auth_error_pgm[]     PROGMEM = "Many Bad try's PIN";

const char data_print_accept_text_pgm[]    PROGMEM = "Confirm";
const char data_print_login_text_pgm[]     PROGMEM = "Login ?";
const char data_print_password_text_pgm[]  PROGMEM = "Password ?";
